...
func ExtractLocation(gr *GeoResponse) LocationResponse {
	...
	return LocationResponse{Error: &NestedError{Status: gr.Status, ErrorMessage: gr.ErrorMessage}}
}
...
func ExtractAddress(gr *GeoResponse) AddressResponse {
	...
	return AddressResponse{Error: &NestedError{Status: gr.Status, ErrorMessage: gr.ErrorMessage}}
}
